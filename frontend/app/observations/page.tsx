        ...
        <section className="bg-[#0a1628] py-16 md:py-20">
          <div className="w-full mx-auto px-4 md:px-6 text-center">
            ...
            <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">
              Browse observations submitted by our community of marine
              enthusiasts from around the world. Every observation contributes
              to marine research and conservation.
            </p>
        ...
        <section className="py-12 bg-card">
          <div className="w-full mx-auto px-4 md:px-6 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
              Your observations help researchers track species distribution,
              monitor population changes, and identify areas in need of
              protection.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" asChild>
                <Link href="/recognize">Use AI Recognition</Link>
              </Button>
            </div>
          </div>
        </section>

...
import { ArrowLeft, MapPin, Users, Calendar, Target, Heart, Share2, Clock, CheckCircle } from "lucide-react"
...
const projectsData: Record<string, {
  ...
  "1": {
    ...
    updates: [
      {
        ...
        content: "We&apos;re thrilled to announce that we&apos;ve successfully transplanted our 10,000th coral fragment this month!",
      },
      {
        date: "2024-02-15",
        title: "New Nursery Established",
        content: "Our team has completed the setup of a new underwater nursery in the northern section of the reef.",
      },
      {
        date: "2024-01-20",
        title: "Community Training Program",
        content: "50 new volunteers completed our coral restoration training program this month.",
      },
    ],
    milestones: [
    ...
    team: [
      { name: "Dr. Sarah Mitchell", role: "Project Lead", avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop" },
      { name: "James Cook", role: "Marine Biologist", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop" },
      { name: "Emily Wong", role: "Community Coordinator", avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop" },
    ],
  },
}
...
const defaultProject = {
  ...
  fullDescription: "Project details are being compiled. Please check back soon for more information about this conservation initiative.",
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="container px-4 md:px-6 pb-8">
              ...
              <div className="flex gap-2 mb-3">
                <Badge className="bg-secondary text-secondary-foreground">{project.status}</Badge>
                <Badge variant="outline" className="text-white border-white/30">{project.category}</Badge>
              </div>
            ...
            <div className="grid md:grid-cols-4 gap-6 items-center">
              <div className="md:col-span-2">
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-muted-foreground">of ${project.goal.toLocaleString()} goal</span>
                </div>
                <Progress value={project.progress} className="h-3" />
                <p className="text-sm text-muted-foreground mt-2">{project.progress}% funded</p>
              </div>
                        ...
                        {project.updates.length > 0 ? (
                          <div className="space-y-6">
                            {project.updates.map((update, index) => (
                              <div key={index} className={index !== project.updates.length - 1 ? "pb-6 border-b" : ""}>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        {project.milestones.length > 0 ? (
                          ...
                          <p className="text-center text-muted-foreground py-8">No milestones defined.</p>
                        )}
                      </CardContent>
                    </Card>
                  </TabsContent>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-medium">{new Date(project.startDate).toLocaleDateString("en-US", { month: "short", year: "numeric" })}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-muted-foreground">End Date</span>
                      <span className="font-medium">{new Date(project.endDate).toLocaleDateString("en-US", { month: "short", year: "numeric" })}</span>
                    </div>
                    <div className="flex justify-between items-center">

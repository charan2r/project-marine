...
const projects = [
  ...
  },
  {
    ...
    location: "Costa Rica",
    description:
      "Protecting critical nesting sites for endangered sea turtle species through beach patrols, nest monitoring, and community education.",
    image:
  ...
  },
  {
    ...
    location: "Indonesia",
    description:
      "Large-scale mangrove planting initiative to restore coastal ecosystems, protect shorelines, and provide habitat for marine species.",
    image:
  ...
  },
  {
    ...
    description:
      "Tracking and studying whale migration patterns using satellite technology to inform conservation strategies and reduce ship strikes.",
    image:
  ...
  },
  {
    ...
    description:
      "Community-driven initiative to remove plastic pollution from beaches and coastal waters across multiple Caribbean islands.",
    image:
  ...
  },
  {
    ...
    description:
      "Scientific expedition to document deep sea biodiversity and discover new species in one of the least explored regions on Earth.",
    image:
        ...
        <section className="bg-[#0a1628] py-16 md:py-24">
          <div className="w-full mx-auto px-4 md:px-6 text-center">
            ...
            <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">
              Join us in making a real impact. Support conservation initiatives
              around the world and help protect our ocean ecosystems for future
              generations.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 bg-card">
          <div className="w-full mx-auto px-4 md:px-6 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
              Have an idea for a conservation initiative? We support communities
              and organizations in launching impactful marine conservation
              projects.
            </p>

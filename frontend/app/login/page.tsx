        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-primary-foreground">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl font-bold leading-tight">
              Welcome back to the ocean community
            </h1>
            <p className="text-lg text-primary-foreground/80 max-w-md">
              Continue your journey of marine discovery. Access your observations, 
              connect with fellow conservationists, and contribute to ocean science.
            </p>
            ...
            <div className="flex items-center gap-8 pt-4">
              ...
              <div>
                ...
                <p className="text-sm text-primary-foreground/70">Observations</p>
              </div>
              <div>
          ...
          <p className="text-sm text-primary-foreground/60">
            Protecting our oceans, one observation at a time.
          </p>
        </div>
      </div>

...
const discussions = [
  {
    id: 1,
    title: "Has anyone spotted the rare Blue-ringed Octopus in the Great Barrier Reef recently?",
    category: "species",
    author: { name: "Marina Chen", avatar: "/avatars/marina.jpg", initials: "MC" },
    replies: 47,
    views: 1234,
    likes: 89,
  ...
  },
  {
    ...
    category: "research",
    author: { name: "Dr. Sarah Waters", avatar: "/avatars/sarah.jpg", initials: "SW" },
    replies: 28,
    views: 567,
    likes: 45,
  ...
  },
  {
    ...
    author: { name: "Elena Costa", avatar: "/avatars/elena.jpg", initials: "EC" },
    replies: 56,
    views: 1023,
    likes: 112,
  ...
  },
  {
    ...
    category: "species",
    author: { name: "OceanWatch Team", avatar: "/avatars/team.jpg", initials: "OW" },
    replies: 73,
    views: 2341,
    likes: 234,
...
const topContributors = [
  { name: "Dr. Sarah Waters", posts: 234, avatar: "/avatars/sarah.jpg", initials: "SW", badge: "Expert" },
  { name: "Marina Chen", posts: 189, avatar: "/avatars/marina.jpg", initials: "MC", badge: "Top Contributor" },
  { name: "Alex Reef", posts: 156, avatar: "/avatars/alex.jpg", initials: "AR", badge: "Photographer" },
  { name: "Elena Costa", posts: 134, avatar: "/avatars/elena.jpg", initials: "EC", badge: "Conservationist" },
  { name: "Tom Diver", posts: 98, avatar: "/avatars/tom.jpg", initials: "TD", badge: "Rising Star" },
]
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-lg text-muted-foreground">
                Connect with marine enthusiasts, share discoveries, ask questions, and learn from experts worldwide.
              </p>
            </div>

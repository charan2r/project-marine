...
const allSpecies = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1545671913-b89ac1b4ac10?w=400&h=300&fit=crop",
  },
  {
    id: 8,
...
const categories = ["All", "Fish", "Mammals", "Reptiles", "Birds", "Invertebrates"]
const habitats = ["All", "Open Ocean", "Coral Reefs", "Coastal Waters", "Deep Sea", "Tropical Waters", "Antarctic Waters"]
        ...
        <section className="bg-[#0a1628] py-16 md:py-24">
          <div className="container px-4 md:px-6 text-center">
            ...
            <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">
              ...
              Learn about different species, their habitats, and conservation status.
            </p>
          </div>
        </section>
        ...
        <section className="py-8 border-b bg-card">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
              ...
              <div className="flex flex-wrap gap-3 items-center">
                ...
                <Select value={selectedHabitat} onValueChange={setSelectedHabitat}>
                  ...
                  <SelectContent>
                    {habitats.map((hab) => (
                      <SelectItem key={hab} value={hab}>{hab}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
            ...
            <div className="mt-4 flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>Showing {filteredSpecies.length} of {allSpecies.length} species</span>
            </div>
          </div>
        </section>
                    ...
                    <Card className="group overflow-hidden h-full hover:shadow-lg transition-shadow">
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="mt-2 flex items-center gap-2">
                          ...
                          <Badge variant="outline" className="text-xs">{species.habitat}</Badge>
                        </div>
                      </CardContent>
                    </Card>
                  </Link>
